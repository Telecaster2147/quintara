...
5. Run `ruff`, `ty` (with the documented vendored-kernel exclusion), `pytest`, `uv build`, and
   `cd docs/openspec/openspec && openspec validate --strict --all` before opening a pull request.
